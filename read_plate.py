...
L, LpImg, lp_type = detect_lp(wpod_net, im2single(Ivehicle), bound_dim, lp_threshold=0.5)
...
if (len(LpImg)):
    ...
    # Ap dung thre shold de phan tach so va nen
    ...
    text = pytesseract.image_to_string(binary, lang="vie", config=custom_config)
